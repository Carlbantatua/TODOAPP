        ...
        <div class="lg:w-2/4 mx-auto py-8 px-6 bg-white rounded-xl">
            ...
            <div class="mb-6">
                <form class="flex flex-col space-y-4" method="POST" action="/">
                    ...
                    <button class="w-20 py-2 px-6 bg-green-500 text-white rounded-xl">Add</button>
            ...
            <div class="mt-2">
                ...
                >
                    <div class="flex-1 pr-8">
                        <h3 class="text-lg font-semibold"> <?php echo e($todo -> title); ?> </h3>
                        <p class="text-gray-500"> <?php echo e($todo -> description); ?>  </p>
                    </div>
                    <div class="flex space-x-3">
                        <form method="POST" action="/<?php echo e($todo -> id); ?>">
                           <?php echo csrf_field(); ?>
                            <?php echo method_field('PATCH'); ?>
                        <button class="py-2 px-3 bg-green-500 text-white rounded-xl">
...
<?php /**PATH C:\Users\abc\TodoApp\resources\views/welcome.blade.php ENDPATH**/ ?>